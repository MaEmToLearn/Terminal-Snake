...
class CoordinatesTest {
    ...
    void increment1() {
        ...
        assertEquals(3, coordinates.column());
    }
    ...
    void increment2() {
        ...
        assertEquals(3, coordinates.row());
        assertEquals(2, coordinates.column());
    }
    ...
    void increment3() {
        ...
        assertEquals(4, coordinates.row());
        assertEquals(3, coordinates.column());
    }
    ...
    void increment4() {
        ...
        assertEquals(1, coordinates.row());
        assertEquals(0, coordinates.column());
    }
}
